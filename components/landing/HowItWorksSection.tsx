  ...
  return (
    <section id="how-it-works" className="py-20 md:py-24 border-b border-default">
      <div className="mx-auto max-w-[1200px] px-4 md:px-8">
        ...
        <div className="mt-14 flex flex-col md:flex-row items-start md:items-start justify-between gap-8 md:gap-4">
          {steps.map((s, i) => (
            <div key={s.n} className="flex-1 flex flex-col items-center text-center relative w-full">
              {i < steps.length - 1 && (
                <div
